...
helm.sh/chart: {{ include "patient-care-api.chart" . }}
...
*/}}
{{- define "patient-care-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "patient-care-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
